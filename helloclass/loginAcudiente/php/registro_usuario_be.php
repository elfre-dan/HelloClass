...
$createTableQuery = "CREATE TABLE IF NOT EXISTS acudiente (
...
$query = "INSERT INTO acudiente (nombre_completo, correo, contrasena)
          VALUES ('$nombre_completo', '$correo', '$contrasena')";


$verificar_correo = mysqli_query($conexion, "SELECT * FROM acudiente WHERE correo='$correo'");
